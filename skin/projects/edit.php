	...
	<div class="row">
		<div class="col">
			...
			<div class="mb-3">
				...
				<input type="text" name="project_name" value="<?php echo $results[0]['project_name']; ?>" class="form-control" id="project_name" tabindex="3" />
			</div>
			<br />
			<div class="mb-3">
				<label for="project_market">Project Market</label>
				<select name="project_market_id" class="form-select" id="project_market" tabindex="5">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="construction_type_id" class="form-select" id="contruction_type" tabindex="7">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="hvac_system_type_id" class="form-select" id="hvac_system_type" tabindex="9">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="project_manager" class="form-select" id="project_manager" tabindex="11">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="hvac_designer" class="form-select" id="hvac_designer" tabindex="13">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="electrical_engineer" class="form-select" id="electrical_engineer" tabindex="15">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="plumbing_designer" class="form-select" id="plumbing_designer" tabindex="17">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="construction_administrator" class="form-select" id="construction_administrator" tabindex="19">
					<option selected>Select...</option>
			...
			<div class="mb-3">
				...
				<select name="status_id" class="form-select" id="status_id" tabindex="21">
					<option selected>Select...</option>
		...
		<div class="col">
			...
			<div class="mb-3">
				...
				<select name="phase_id" class="form-select" id="phase_id" tabindex="21">
					<option selected>Select...</option>
