<form method="post" action="/index.php">
	...
	<div class="mb-3">
		...
		<input type="text" name="square_footage" id="square_footage" class="form-control" tabindex="5" />
	</div>
	<br />
	<div class="row">
		<div class="col">
			<div class="mb-3">
				...
				<input type="text" name="study_fee" id="study_fee" class="form-control" tabindex="6" />
			</div>
			<br />
			<div class="mb-3">
				<label for="dd_fee">DD Fee</label>
				<input type="text" name="dd_fee" id="dd_fee" class="form-control" tabindex="8" />
			</div>
			<br />
			<div class="mb-3">
				<label for="bidding_fee">Bidding Fee</label>
				<input type="text" name="bidding_fee" id="bidding_fee" class="form-control" tabindex="10" />
			</div>
			<br />
			<div class="mb-3">
				<label for="closeout_fee">Closeout Fee</label>
				<input type="text" name="closeout_fee" id="closeout_fee" class="form-control" tabindex="12" />
			</div>
			<br />
			<div class="mb-3">
		...
		<div class="col">
			<div class="mb-3">
				...
				<input type="text" name="sd_fee" id="sd_fee" class="form-control" tabindex="7" />
			</div>
			<br />
			<div class="mb-3">
				<label for="cd_fee">CD Fee</label>
				<input type="text" name="cd_fee" id="cd_fee" class="form-control" tabindex="9" />
			</div>
			<br />
			<div class="mb-3">
				<label for="ca_fee">CA Fee</label>
				<input type="text" name="ca_fee" id="ca_fee" class="form-control" tabindex="11" />
			</div>
			<br />
			<div class="mb-3">
				<label for="hvac_fee_percentage">HVAC Fee %</label>
				<input type="text" name="hvac_fee_percentage" id="hvac_fee_percentage" class="form-control" tabindex="13" />
			</div>
			<br />
			<div class="mb-3">
				<label for="plumbing_fee_percentage">Plumbing Fee %</label>
				<input type="text" name="plumbing_fee_percentage" id="plumbing_fee_percentage" class="form-control" tabindex="15" />
			</div>
			<br />
		</div>
	</div>
